...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen relative home-background">
      ...
      <div className="w-[30%] h-64 border border-white yellow-gradient absolute bottom-0 right-0 drop-shadow-2xl rounded-tl-full rounded-bl-full z-0"></div>
      <Navbar />
      <main className="relative flex flex-col-reverse items-center justify-center text-center pt-32 md:flex-row">
        ...
        <div className="flex flex-col gap-2 items-start md:ml-12 lg:ml-80">
          ...
          <br />
          <Button size="xl" className="rounded-3xl px-16 text-xl" onClick={() => navigate('/home')}>
            Lets Start
          </Button>
        </div>
      </main>
